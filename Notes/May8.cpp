...
public:
	...
	string snap() {return "Dog_Snap"; }	//redefines the same constructor
};
...
public:
	...
	const string & sound() const { return _sound; }
	string snap() { return "Animal_Snap"; }	//redefine same signature 
	virtual string move() = 0; //Pure virtual function. FORCE ALL DERIVED CLASS TO DEFINE
...
public:
	...
	virtual string move() override { return "Dog_Move"; } 
};
